    ...
    <div className="space-y-2">
      ...
      <div className="space-y-2 max-h-64 overflow-y-auto">
        {recentBets.map((bet) => (
          <div
            key={bet.id}
            className="flex items-center justify-between p-2 rounded-lg bg-white/5 hover:bg-white/10 transition-colors backdrop-blur-sm border border-white/10"
          >
            ...
            <div className="flex items-center gap-2">
              {bet.status === 'pending' && (
                <div className="flex items-center gap-1 text-[#D4A853] text-xs">
