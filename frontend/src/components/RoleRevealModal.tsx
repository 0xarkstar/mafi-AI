...
import { Shield, Sword, Eye as EyeIcon } from 'lucide-react';
...
const getRoleConfig = (role: Role | undefined) => {
  if (role === Role.MAFIA) {
    return {
      label: 'MAFIA',
...
export const RoleRevealModal = ({ show, role, onDismiss }: RoleRevealModalProps) => {
